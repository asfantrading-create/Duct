...
const { PREFIX, bytesToB64u } = require('./license-format');

function buildPayload({ name, email, type = 'lifetime', expires = null, machine = null, notes, modules, role, seats, issued }) {
  ...
  return {
    ...
    issued: issued || new Date().toISOString().slice(0, 10), expires: type === 'subscription' ? expires : null,
