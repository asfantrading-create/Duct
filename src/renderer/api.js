...
function createMock() {
  ...
  const st = Object.assign({ license: null, settings: { lang: 'ar', units: 'si', theme: 'dark', classroomFolder: null, autoDownloadUpdates: true, city: 'riyadh' }, profiles: [], results: {}, pin: null, classes: [] }, load());
