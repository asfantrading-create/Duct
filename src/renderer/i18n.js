...
export const DICT = {
  ...
  nav_settings: { ar: 'الإعدادات', en: 'Settings' }, nav_guide: { ar: 'دليل الاستخدام', en: 'User Guide' }, nav_gallery: { ar: 'معرض الدكت 3D', en: 'Duct 3D Gallery' }, nav_about: { ar: 'حول البرنامج', en: 'About' }, nav_modules: { ar: 'الوحدات', en: 'Modules' }, nav_system: { ar: 'النظام', en: 'System' },
  ...
  internalLicense: { ar: 'ترخيص داخلي – موظفو أصفان', en: 'Internal licence – ASFAN staff' }, planMonthly: { ar: 'اشتراك شهري', en: 'Monthly subscription' }, planYearly: { ar: 'اشتراك سنوي', en: 'Annual subscription' }, planCustom: { ar: 'اشتراك', en: 'Subscription' }, expiresOn: { ar: 'ينتهي في', en: 'expires on' }, renewNow: { ar: 'تجديد الاشتراك', en: 'Renew subscription' }, daysLeft: { ar: 'يوم متبقٍ', en: 'days left' },
